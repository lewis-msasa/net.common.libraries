...
namespace Common.Libraries.USSD.TNM
{
    ...
    {
        public static IServiceCollection AddUSSDTNMDependencies(this IServiceCollection services, Assembly[] assemblies)
        {
        
            
            services.AddScoped<SocketTcpServer, TNMSocketServer>();
